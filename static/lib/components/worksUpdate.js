...
var worksUpdate = Vue.extend({
      ...
      +'<ul class="nav"><li v-link="{path: \'/bookBlockList\'}"><span class="circular"></span><span class="title_name">轻小说</span></li><li v-if="showFlag === 999"><span class="circular"></span><span class="title_name">画集</span></li><li class="active" v-link="{path: \'/works_update/\' + id}"><span class="circular"></span><span class="title_name">修改信息</span></li></ul>'
      ...
      +'<div class="works_title"><ul><li class="works_sign"></li><li>修改作品</li><li class="works_sont">create a work</li></ul></div><div class="works_name">'
      +'<p class="works_titleSmall">书名：<input type="text" maxlength="64" v-model="bookName" disabled="disabled" /></p>'
    ...
    getValue() {
      ...
      (response) => {
        console.log(response);
		    ...
		    this.$els.img.src = PathList.ImagePath +  + response.data.bookCustom.bookCoverImage;
