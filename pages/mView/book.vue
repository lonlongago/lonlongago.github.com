<template>
  <div style="font-size: 12px; position: relative;">
    <div class="book_details">
      <img :src="path.imagePath + bookCoverImage" style="position: absolute;left: 0;margin: 0;z-index: -1;width: 100%;-webkit-filter:blur(30px);-moz-filter: blur(30px);-ms-filter: blur(30px);-o-filter: blur(30px);filter: blur(30px);" ref="imgData" />
    
      <div style="position: absolute; left: 0; right: 0; top: 0; bottom: 0; background-color: rgba(0,0,0,0.3); z-index: 0;"></div>
      <div class="book_cover" style="position: relative;">
        <img :src="path.imagePath + bookCoverImage" style="width: 100%; height: 100%;"/>
      </div>
      <div class="book_information" style="position: relative;">
        <div class="book_part book_author">
          <span class="book_span" style="background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/touxiang.png);"></span>
          <span class="book_title">作者：</span>
          <span>{{author}}</span>
        </div>
        <div class="book_part book_type">
          <span class="book_span" style="background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/type.png);"></span>
          <span class="book_title">分类：</span>
          <span>{{type}}</span>
        </div>
        <div class="book_part book_num">
          <span class="book_span" style="background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/num.png);"></span>
          <span class="book_title">字数：</span>
          <span>{{num}}</span>
        </div>
        <div class="book_part book_click">
          <span class="book_span" style="background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/click.png);"></span>
          <span class="book_title">点击：</span>
          <span>{{clickNum}}</span>
        </div>
        <div class="book_part book_updatetime">
          <span class="book_span" style="background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/time.png);"></span>
          <span class="book_title">更新时间：</span>
          <span>{{updateTime}}</span>
        </div>
        <div class="book_part book_model">
          <span class="book_span" style="background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/model.png);"></span>
    ...
    <div class="menuAndIntroduction">
      <div class="menu">
        ...
        <div class="menu_time" @click="cataFn(bookId)">
      ...
      <div class="introduction">
        ...
        <div class="introduction_control" @click="openIntroduction()" :style="objHeight?'background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/bottom.png);':'background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/top.png);'"></div>
      </div>
    </div>
    <div class="book_line"></div>
    <div class="author_msg">
      <div class="author_img">
        <img :src="path.imagePath + userHeader" style="width: 100%; height: 100%; border-radius: 100%;" onerror="javascript:this.src='http://cdn.qcacg.com/mobile/img/user_info_touxiang.jpg'" />
      </div>
      ...
      <div class="author_attention btn" @click = "updateAttention()">
        <span v-if="sign" class="attention" style="font-size: 0.1152rem;"><img src="http://cdn.qcacg.com/mobile/img/app_newBook/xin.png" style="width: 0.1152rem; height: 0.1152rem; vertical-align: text-top;"><span style="font-size: 0.1152rem; vertical-align: top;">已关注</span></span>
    ...
    <div class="goodManList">
      <div class="good_menu">
        ...
        <div class="menu_time">
          <a href="javascript:;" @click="gotoGoodMan()" style="color: #989898; background-image: url(/img/app_newBook/right.png); background-repeat: no-repeat; padding-top:0.02rem;background-size: 0.065rem 0.11rem; background-position: center right; padding-right: 0.085rem;float: right;font-size: 0.1195rem;">{{cardAmount}}</a>
        </div>
      </div>
      <div class="good_menuList">
        <div class="good_menuList_brand">
          <div v-for="(obj,index) in totalWorBookReward" class="good_part" v-if="index < 3">
            <div class="good_header" style="background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/first.png);" v-if="index==0"></div>
            <div class="good_header" style="background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/second.png);" v-if="index==2"></div>
            <div class="good_header" style="background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/thired.png);" v-if="index==1"></div>
            <div class="good_portrait">
              <img :src="path.imagePath + obj.userHead" style="width: 0.3584rem; height: 0.3584rem; border-radius: 100%;" onerror="javascript:this.src='http://cdn.qcacg.com/mobile/img/user_info_touxiang.jpg';" alt="" />
            </div>
        ...
        <div class="good_menuList_first" v-if="loginFlag" key="1">
          <div class="good_portrait">
            <img src="http://cdn.qcacg.com/mobile/img/app_newBook/people.png" style="width: 0.3584rem; height: 0.3584rem;"/>
          </div>
          <div class="good_name">{{loginObj.status.userName}}</div>
        </div>
        <div class="good_menuList_first"  style="line-height: 0.7467rem;" v-else key="2">
          <a href="javascript:;" @click="loFn()">您还未登录</a>
        </div>
      </div>
    </div>
    <div class="book_line" style="height:0.0512rem;"></div>
    <div class="book_comment">
      <div class="comment_header">
        ...
        <a href="javascript:;" @click="goCommentFirst(bookId)" style="color: #989898; background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/right.png); background-repeat: no-repeat; padding-top:0.02rem;background-size: 0.065rem 0.11rem; background-position: center right; padding-right: 0.085rem;float: right;font-size: 0.1195rem;">{{commentCount}}条</a>
      </div>
      <div class="comment_list">
        <div class="comment_part" v-for="(temp,index) in comment" v-if="index<=1">
          <div class="comment_user">
            ...
            <img :src="path.imagePath + temp.userHead" style="border-radius: 100%;" onerror="javascript:this.src='http://cdn.qcacg.com/mobile/img/user_info_touxiang.jpg'" alt="" />
          </div>
          <div class="comment_content">
            ...
            <div class="comment_other_reply" v-if="temp.replyEntityList.length!=0">
              <div class="comment_reply_part" >
                <div class="user_comment" >
                  <div class="user_comment" v-for="(obj,index) in temp.replyEntityList">
                    <div v-if="obj.replyStatus==0" style="padding-bottom: .128rem;">
                      <span>
                        <span style="font-size: 0.1024rem;">{{obj.userName}}</span>:
                      </span>
                      <span style="white-space: normal; width: 100%;word-wrap:break-word; overflow:hidden; color: #656565;font-size: 0.1024rem;" v-html="obj.replyContent">{{ obj.replyContent }}</span>
                    </div>
                    <div v-if="obj.replyStatus==1" style="padding-bottom: .128rem;">
                      <span class="aite_user" >
                        <span style="font-size: 0.1024rem; display: inline-block;">{{obj.userName}}</span>
                        <span style="color: lightskyblue;display: inline-block;">@</span>
                        <span style="font-size: 0.1024rem;display: inline-block;">{{obj.replyUserName}}</span>:
                      </span>
                      <span style="white-space: normal;width: 100%;word-wrap:break-word; overflow:hidden; color: #656565;font-size: 0.1024rem;" v-html="obj.replyContent">{{ obj.replyContent }}</span>
                    </div>
                  </div>
              ...
              <a href="javascript:;" @click="goCommentDetails(temp.commentId,bookId)" class="comment_reply_count" style="font-size: 0.1024rem;">共{{temp.replyEntityList.length}}条回复</a>
            </div>
          </div>
        </div>
        <a href="javascript:;" @click="goCommentFirst(bookId)" class="comment_move" >查看全部评论</a>
      </div>
    </div>
    <div class="book_footer">
      <div class="footer_left" @click="setCollect()">
        <img src="http://cdn.qcacg.com/mobile/img/app_newBook/xingxing.png" style="width: 0.1536rem; height: 0.1536rem;"/>
      ...
      <div class="footer_right" @click = "commentFn(bookId)">
        <!--<span></span>-->
        <img src="http://cdn.qcacg.com/mobile/img/app_newBook/shuxie.png" style="width: 0.1707rem; height: 0.1536rem;"/>
    ...
    <transition name="fade">
      <div class="share_bottom" v-show="shareBol">
        ...
        <div class="share_dirction">
          <a href="javascript:;" class="share_part"@click="shareAction(3)">
            <img src="http://cdn.qcacg.com/mobile/img/app_newBook/xinlang.png">
            <p>新浪微博</p>
          </a>
          <a href="javascript:;" class="share_part" @click="shareAction(2)">
            <img src="http://cdn.qcacg.com/mobile/img/app_newBook/weixin.png">
            <p>微信好友</p>
          </a>
          <a href="javascript:;" class="share_part"  @click="shareAction(2)">
            <img src="http://cdn.qcacg.com/mobile/img/app_newBook/friend.png">
            <p>微信朋友圈</p>
          </a>
          <a href="javascript:;" class="share_part" @click="shareAction(0)">
            <img src="http://cdn.qcacg.com/mobile/img/app_newBook/qq.png">
            <p>QQ好友</p>
          </a>
          <a href="javascript:;" class="share_part" @click="shareAction(0)">
            <img src="http://cdn.qcacg.com/mobile/img/app_newBook/qqkone.png">
            <p>QQ空间</p>
          </a>
          <a href="javascript:;" class="share_part">
            <img src="http://cdn.qcacg.com/mobile/img/app_newBook/copy.png">
            <p>复制链接</p>
          </a>
        </div>
      </div>
    ...
    <transition name="fade">
      <div class="reward_bottom" v-if="rewardBol">
        <div class="reward_title">
          ...
          <a href="javascript:;" @click="gotoGoodMan()">好人榜</a>
        </div>
...
//        obj.volumeCustomList = perms.data.bookCustom.volumeCustomList;
    ...
    methods:{
      plusReady:function(){
        ...
        this.view.drawBitmap('_www/img/share.png',{top:'0px',left:'0px',width:'100%',height:'100%'}, {top:'12px',left:(self.mWidth-45).toString()+'px',width:'20px',height:'20px'})
//	  	this.view.setTouchEventRect({top:'0px',left:(self.mWidth-45).toString()+'px',width:'44px',height:'44px'});
		  	this.view.interceptTouchEvent(true);
		  	this.view.addEventListener("click", self.showShareFn, false);
      ...
      showShareFn:function(e){
      	if(e.clientX>this.mWidth - 45){
      		this.showShare();
      	}
      },
      cataFn: function(bk){
      	if(window.plus){
	      		this.webBook = plus.webview.create(appPathList.netWorks+"/catalog/" + bk,'catalog',
	      		{
			        'popGesture':'close',
			        'titleNView':{'backgroundColor':'#ffffff','titleText':'目录','titleColor':'#000000','autoBackButton':true,splitLine:{color:'#C3C3C3'}},
...
//    	location.href = "/mView/catalog/" + bk;
      },
      openWebviewfn:function(url,name){
        var viewObj = {};
        viewObj = plus.webview.create(url,name,{left:'100%',render:'always'});
        viewObj.show('none');
        viewObj.drag({direction:'right',moveMode:'followFinger'}, {view:this.ws,moveMode:'follow'}, function(e){
            console.log(JSON.stringify(e));
        });
        return viewObj
      },
      webviewAnimation:function(viewObj){
        plus.webview.startAnimation({view:this.ws,styles:{fromLeft:'0%',toLeft:'-100%'},action:'none'},{view:viewObj,styles:{fromLeft:'100%',toLeft:'0%'},action:'none'},function(e){
          console.log(JSON.stringify(e))
          console.log('操作成功')
        });
      },
      shareAction:function(a) {
        var self = this;
        var s =null;
        if(this.iosOrAndriod==0){
         return
        }
        if(this.iosOrAndriod==2){
//        s = this.shares[a];
          if(a==3){
            s = this.shares[3]
          }
...
//        s = this.shares[a];
      ...
      recharge:function(){
        if(this.loginFlag){
          if(window.plus){
            this.webBook = plus.webview.create(appPathList.netWorks+'/goodCard1','goodCard1',
            {
			        'popGesture':'close',
...
//      this.bookMenu = true;
      ...
      goCommentDetails:function(a,b){
        if(window.plus){
          this.webBook = plus.webview.create(appPathList.netWorks+'/commentDetails/'+a+'&'+b,'commentDetails',
          {
			        'popGesture':'close',
...
//        location.href = "/mView/commentDetails/"+a+'&'+b;
        }
      },
      goCommentFirst:function(a){
      	if(!this.loginFlag){
      		if(window.plus){
            this.webBook = plus.webview.create(appPathList.netWorks+'/login','login',
            {
        ...
        if(window.plus){
          this.webBook = plus.webview.create(appPathList.netWorks+'/commentFirst/'+a,'commentFirst',
          {
			        'popGesture':'close',
...
//        location.href = "/mView/commentFirst/"+a;
        }
      },
      gotoGoodMan:function(){
        if(window.plus){
          this.webBook = plus.webview.create(appPathList.netWorks+'/goodMan/'+this.bookId,'goodMan',
          {
			        'popGesture':'close',
			        'titleNView':{'backgroundColor':'#ffd700','titleText':'','titleColor':'#000000','autoBackButton':true,splitLine:{color:'#C3C3C3'}},
...
//        location.href = "/mView/goodMan/"+this.bookId;
        }
      },
...
//        location.href = "/mView/readBook/"+a+"&"+b;
        }
      },
      goBack:function(){
        if(window.plus){
...
//          location.href = "/mView/login";
      ...
      readBookFn:function(){
        if(window.plus){
          this.webBook = plus.webview.create(appPathList.netWorks+'/readBook/'+this.contentId+"&"+this.bookId,'readBook',{'popGesture':'close'});
           this.webBook.onloading= function(){
							plus.nativeUI.showWaiting('',{'background':'rgba(0,0,0,0.2)'});
						}
						this.webBook.onloaded=function(){
      ...
      getRewardFn:function(){
        ...
        SZXJ.http(this,'get', appPathList.cardgive+"?amount="+this.amount+"&bookId="+this.bookId,{}, (response) => {
            if(response.data.code == 200){
            	if(window.plus){
			    			plus.nativeUI.toast( "打赏成功");
			    		}
//            this.$refs.appAlert.setMessage("打赏成功");
              self.getGoodCard();
              self.getBookRankFn();
...
<style>
  ...
  .header_book .header_share .header_share_tu{
    ...
    width: .2048rem;
    height: .2048rem;
    background-image: url('http://cdn.qcacg.com/mobile/img/app_newBook/share.png');
    background-repeat: no-repeat;
    background-size: contain;
  ...
  .book_share .book_left_reward .qiu_reward{
    ...
    height: 0.2048rem;
    border-radius: 100%;
    background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/reward.png);
    background-position: center;
    background-repeat: no-repeat;
    background-size: contain;
    display: inline-block;
  ...
  .book_share .book_right_share .qiu_share{
    ...
    display: inline-block;
    margin-right: 0.0427rem;
    background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/share1.png);
    background-position: center;
    background-repeat: no-repeat;
    background-size: contain;
  }
  ...
  .menuAndIntroduction .introduction .introduction_control{
    width: 100%;
    height: 0.182rem;
    background-image: url(http://cdn.qcacg.com/mobile/static/img/app_newBook/top.png);
  ...
  .book_comment .comment_list .comment_move{
    ...
    background-image:url(http://cdn.qcacg.com/mobile/img/app_newBook/red_right.png); 
    background-repeat: no-repeat; 
  ...
  .book_comment .comment_list .comment_part .comment_content .comment_user_reply p{
  	color: #656565;
  }
  ...
  .reward_bottom .reward_title a{
    color: #ff616f;
    background-image: url(http://cdn.qcacg.com/mobile/img/app_newBook/red_right2.png);
    background-repeat: no-repeat; 
