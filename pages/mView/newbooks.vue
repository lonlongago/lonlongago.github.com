		...
		<div class="all">
			...
			<div id="xiagu">
				...
				<div class="below">
					...
					<div class="acti">
						<div class="activity" @click="actiFn">
							<span class="acone">活动(选填)</span>
							<span class="actwo">{{activ}}</span>
							<img class="goto" src="http://cdn.qcacg.com/img/app_index/classification_010.png" alt="" />
						</div>
					</div>
				</div>
			...
			<div class="cover" v-if="actFlag">
			    <div class="gxway">
			      	<span class="xc">活动</span>
			      		<a href="javascript:;" @click="setMov(1)">
				      		<div style="width: 100%;" @click="reverseAct(1,'无')">
						      <p :style = "activey==1?'color:#ffc200':'color:#323232'" >无</p>
						      <img :src="activey == 1?'http://cdn.qcacg.com/mobile/img/duise.png':'http://cdn.qcacg.com/mobile/img/kong.png'"/>
				      		</div>
					    </a>
					    <a href="javascript:;" @click="setMov(2)">
						    <div style="width: 100%;" @click="reverseAct(2,'秋季征文')">
						      <p :style = "activey==2?'color:#ffc200':'color:#323232'">秋季征文</p>
						      <img :src="activey == 2?'http://cdn.qcacg.com/mobile/img/duise.png':'http://cdn.qcacg.com/mobile/img/kong.png'"/>
						    </div>
					    </a>
			      	<div class="anniu">
				      	<div class="confirm" @click="painterFlagFn(1)" >确认</div>
...
<style>
	...
	*{margin:0;padding:0;font-family:sansSerif;list-style:none;outline: none;color:#000;text-decoration:none;line-height: 1;user-select:none;}
	#xiagu{/*margin-top: .9rem;*/width: 100%;height: 100%;}
	...
	.acti{position: relative;background-color: white;top: .2rem;height: .8rem;padding: 1.5% 2%;left: 0;right: 0;}
	.acti .activity{margin-left: .32rem;}
	.acti .activity .acone{font-family: "微软雅黑";font-size: .32rem;line-height: .6rem;}
	.acti .activity .actwo{color: rgba(0,0,0,.45);float: right;font-family: "微软雅黑";font-size: .28rem;line-height: .6rem;margin-right: 1rem;}
	.acti .activity .goto{box-sizing:border-box;height:.85rem;width:auto;position:absolute;display:block;top:0;left:7%;padding:0.3rem 0;left:90%;padding-left: .1rem;}
	...
	#newboks .all .below .bkals{background-color:#fff;width: 100%;height:.6rem;padding:1.5% 2%;border-bottom:1px rgba(0,0,0,.08) solid;}
	#newboks .all .below .bkals .bokna{margin-left: .32rem;/*margin-top:1%;*/position:relative;height: .6rem;}
	#newboks .all .below .bkals .bokna img{box-sizing:border-box;height:.85rem;width:auto;position:absolute;display:block;top:-20%;left:7%;padding:0.28rem 0;}
	#newboks .all .below .bkals .bokna .goto{padding:0.3rem 0;left:88%;padding-left: .1rem;}
	...
	#newboks .all .below .bkals .bokna .shang{font-size: .32rem;line-height:.6rem;}
	#newboks .all .below .bkals .bokna .xian{color: rgba(0,0,0,.45);font-size: .28rem;float: right;margin-right: 1.2rem;/*margin-top: .16rem;*/line-height:.6rem;}
