<template>
	<div v-show="displayFlag" style="display: none;" id="system" class="system">
		<script src="/lib/resize.js"></script>
		<script src="/lib/pullToRefresh.js"></script>
		<div id="pull"></div>
		<div class="content">
		    <myheader msg="系统消息"></myheader>
...
<style>
		...
		.system .content{max-width: 7.5rem;margin:0 auto;position:relative;min-height:12rem;margin-top: 0.88rem;}
		.system .content .main{background-color:#fff;padding:3% 0;border-bottom:1px solid rgba(0,0,0,.055)}
		.system .content .main .right{display:inline-block;vertical-align:middle;width:80%;margin-left:10%}
		.system .content .main .right .title{font-size:.28rem;display:inline-block;width:75%;vertical-align:middle}
		.system .content .main .right .title div{width:80%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
		.system .content .main .right .mess{font-size:.24rem;margin-top:3%;min-height:.26rem;text-indent:.26rem}
		.system .content .main .right .uptime{display:inline-block;font-size:.2rem;color:#777;vertical-align:middle}
</style>