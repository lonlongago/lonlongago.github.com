<template>
	<div style="background-color: #F1F1F1">
		...
		<div id="space_Index">
			...
			<!--档案-->
			<div id="space_fileshows">
				<div class="space_shows_lt">
					<div class="star">
						<ul class="detail">
							<li>
							  <span>总评价<i>:</i></span>
								<img :src=" all.totalEvaluateLevel >= 1 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
							    <img :src=" all.totalEvaluateLevel >= 2 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
							    <img :src=" all.totalEvaluateLevel >= 3 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
							    <img :src=" all.totalEvaluateLevel >= 4 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
							    <img :src=" all.totalEvaluateLevel == 5 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
							</li>
							<li>
							  <span>画稿质量<i>:</i></span>
				                <img :src=" all.qualityEvaluateLevel >= 1 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
				                <img :src=" all.qualityEvaluateLevel >= 2 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
				                <img :src=" all.qualityEvaluateLevel >= 3 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
				                <img :src=" all.qualityEvaluateLevel >= 4 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
				                <img :src=" all.qualityEvaluateLevel == 5 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
							</li>
							<li>
							  <span>专业度<i>:</i></span>
				                <img :src=" all.majorEvaluateLevel >= 1 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
				                <img :src=" all.majorEvaluateLevel >= 2 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
				                <img :src=" all.majorEvaluateLevel >= 3 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
				                <img :src=" all.majorEvaluateLevel >= 4 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
				                <img :src=" all.majorEvaluateLevel == 5 ?  '/img/painter/star_02.png':'/img/painter/star_01.png'"/>
							</li>
						</ul>
					</div>
					<div class="label">
						<div class="title">Ta的标签<i>:</i></div>
						<ul class="label_con">
							<li v-for="obj in whole.evaluateLabelAllData" class="one">{{obj}}</li>
						</ul>
					</div>
					<div class="left">
						<div class="space_lt_con">
							<div class="space_shows_title">
								<a class="books" href="#">档案</a>
								<div class="hr"></div>
								<div class="books_count">
									<p>共<span class="books_num">{{paintNumData.totalEvaluateNum}}</span>条</p>
								</div>
							</div>
							<div class="file" v-for="space in spaceList">
								<p class="file_title">{{space.title}}<span>￥{{space.totalAmount}}</span></p>
								<ul class="file_eval">
									<li><span>总评价<i>:</i></span>
                      						<img v-if=" space.totalEvaluateLevel >= 1 " src="data:image/png;base64," />
                     						<img v-if=" space.totalEvaluateLevel >= 2 " src="data:image/png;base64," />
                     						<img v-if=" space.totalEvaluateLevel >= 3 " src="data:image/png;base64," />
                     						<img v-if=" space.totalEvaluateLevel >= 4 " src="data:image/png;base64," />
                     						<img v-if=" space.totalEvaluateLevel >= 5 " src="data:image/png;base64," />
									</li>
									<li><span>画稿质量<i>:</i></span>
                      						<img v-if=" space.qualityEvaluateLevel >= 1 " src="data:image/png;base64," />	
                      						<img v-if=" space.qualityEvaluateLevel >= 2 " src="data:image/png;base64," />
                      						<img v-if=" space.qualityEvaluateLevel >= 3 " src="data:image/png;base64," />
                      						<img v-if=" space.qualityEvaluateLevel >= 4 " src="data:image/png;base64," />
                      						<img v-if=" space.qualityEvaluateLevel >= 5 " src="data:image/png;base64," />
									</li>
									<li><span>专业度<i>:</i></span>
											<img v-if=" space.majorEvaluateLevel >= 1 " src="data:image/png;base64," />
											<img v-if=" space.majorEvaluateLevel >= 2 " src="data:image/png;base64," />
											<img v-if=" space.majorEvaluateLevel >= 3 " src="data:image/png;base64," />
											<img v-if=" space.majorEvaluateLevel >= 4 " src="data:image/png;base64," />
											<img v-if=" space.majorEvaluateLevel >= 5 " src="data:image/png;base64," />
								  	</li>
								</ul>
								<div class="file_bref">{{space.content}}</div>
								<div class="file_author">
									<img v-bind:src=" path.ImagePath + 'Controller' + space.userHead" onerror="javascript:this.src='data:image/jpeg;base64,';" src="data:image/jpeg;base64,"  alt="" />
									<p>{{space.userName}}</p>
									<span>发表于<i>{{szxj.getLocalTimeTwo(space.createTime)}}</i></span>
								</div>
							</div>
						</div>
					</div>
...
//						Utils.setMessage(false, '申请成功');
	    ...
	    getValueFn:function(){
	      ...
	      SZXJ.http(this,'get',PathList.queryArchives,{ userId:this.id }, (response) => {
					this.whole = response.data;
	    			this.all = response.data.evaluateScoreData;
			        ...
			        this.spaceList = response.data.detailedEvaluateInfoData.list;
			        this.paintNumData = response.data.totalEvaluateNumData;
			        this.canCompileData = response.data.canCompileData.canCompile;
			        for(var i = 0 ; i < 3 ; i++){
			          if(this.all.totalEvaluateLevel == 'NaN'){
			             this.all.totalEvaluateLevel = 0;
			          }else if(this.all.qualityEvaluateLevel == 'NaN'){
			            this.all.qualityEvaluateLevel = 0;
			          }else if(this.all.majorEvaluateLevel == 'NaN'){
		                this.all.majorEvaluateLevel = 0;
		              }
			        }  
			  }); 
	    },
