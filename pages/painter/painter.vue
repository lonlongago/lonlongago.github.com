					...
					<li v-for = "(obj,index) in authorList">
						...
						<!--<div class="book_con">
							...
							<div class="book_con">
								...
								<div class="person_berif">
									<p class="explain">个人说明：</p>
									<div class="explain_C">{{obj.information}}</div>
								</div>
							</div>
						<!--</div>-->
						<div style="float:left;width:550px;height: 100%;">
						 	<div class="book_pic" v-for=" img in obj.albums" >
			                	<a :href="'worksDetails/' + img.albumId ">
			                    	<img class="book_num" v-if=" index < 4 "  :src="img.coverPicturePath + '&imageView2/1/w/124/h/174/interlace/1/q/100|imageslim'"  onerror="javascript:this.src='/img/z-imgBj.jpg';"/>
			                    </a>
			                </div>
						</div>
						<a class="book_more" :href="'space/' + obj.userId "><p>更多作品</p></a>
					</li>
				</ul>
			</div>
			<div class="author_lists" v-if="tapNumber == 2">
		        <ul class="list_con">
			        <li v-for = "(obj,index) in authorList">
			            <div class="con_pic">
			              <a class="pic_wrap" :href="'/painter/space/' + obj.userId ">
			              <img class="pic" :src=" path.ImagePath + 'Controller' + obj.userHead" onerror="javascript:this.src='data:image/jpeg;base64,';" /></a>
			              <span v-if="obj.isFans == 0 || !loginFlag" @click="setAttention(obj.userId,index,1)" class="pic_atten">+关注</span>
			              <span v-else @click="setAttention(obj.userId,index,2)" class="pic_atten already">已关注</span>
			            </div>
			            ...
			            <a class="book_more" :href="'/painter/space/' + obj.userId "><p>更多作品</p></a>
			        </li>
		        </ul>
	      	</div>
...
export default {
    ...
    mounted: function () { // ready -->
		this.$nextTick(function () {
			this.getMoreValueFn();
			if(SZXJ.getQueryString('key')){
		       this.searchKeyFn(SZXJ.getQueryString('key'));
		  }
		    this.getValueFn();
		})
	...
	methods: {
		getValueFn:function(){ // 默认请求
		    ...
		    this.$refs.page.setFn(function(){
	    		...
	    		self.getAlbumByFilter();
	    	});
	    },
	    getAlbumByFilter:function(){
	    	SZXJ.http(this,'get', PathList.listAlbumByFilter, this.obj, (response) => {
		        this.listAlbum = response.data.data;
		        this.$refs.page.setPageCount(response.data.data.pages);
		    });
	    },
		tapMove: function(v){
			this.tapNumber = v;
	    ...
	    setAttention: function(a,b,c){
	      if(this.loginFlag){
	        SZXJ.http(this,'post', PathList.saveOrCancelAttention, {receiveId:a}, (response) => {
	          if(c == 1){
	            this.authorList[b].isFans = 1 ;
	            this.authorList[b].fansAmount += 1;
	          }else{
	            this.authorList[b].isFans = 0 ;
	            this.authorList[b].fansAmount -= 1;
	          }
	        });
	      }else{
	        this.$refs.alert.setMessage(true,"亲，请先登录",function(){
			 		location.href='/login';
			 	});
			 	return;
	      }
	    ...
	    setPageCount: function(v) {
	    	v = 2;
	        var obj = this.objIndex;
	        obj.pageCount =  v;
	        this.page = [];
	        for (var i = 0; i < obj.pageCount; i++) {
	            this.page.push(i+1);
	        } 
	        this.objIndex.pagaCount = v;
	    },
	    setPage: function(v) {
...
//	      });
//	      
//	      SZXJ.http(this,'get', PathList.morePainter,this.obj, (response) => {
...
//	    },
	    ...
	    getMoreValueFn: function(){
	    	SZXJ.http(this,'get', PathList.morePainter,this.obj, (response) => {
	            this.authorList = response.data.data.list;
	            this.setPageCount(response.data.data.lastPage);
	        });
	    }
    },
  	head: function(){
		return {
			...
			link: [
		    	{ rel: 'stylesheet', href: '/painter/css/main_painter1.css' },
